...
window.TR_CHOICES = {'NOTIFICATION_EMAILS':[[0,'never'],[1,'once a months'],...[4,'always']],...}
"""

JS_TRANSLATIONS_CHOICES = ('NOTIFICATION_EMAILS', 'LOOKINGFOR_CHOICE',
...
NOTIFICATION_EMAILS = (
        ...
        (2, 'once a week'),
        (3, 'once a day'),
        (4, 'always'), # when ever something happens (received message, friend request, etc.)
    )
