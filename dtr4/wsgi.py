...
#
# WSGIPythonHome /opt/elligue/venv/dtr4/bin/python
# WSGIDaemonProcess elligue4 python-path=/opt/elligue/dtr4:/opt/elligue/venv/dtr4/lib/python3.2/site-packages
